...
ContenidoMail = "<p>Estimado/a" & nombre & "</p>" _
& " <p>Mi nombre es " & mi_Nombre & " le escribo del equipo comercial de Loi Suites Hoteles, esperando que usted y sus seres queridos se encuentren muy bien en estos momentos. </p>" _
& " <p>Nos encantaría saber si suelen utilizar los servicios de hotelería, para poder acercarles una propuesta comercial de alojamiento en caso que suelan utilizar estos servicios en la ciudad de Buenos Aires, en especial para funcionarios, colaboradores, gerentes, CEO de vuestra empresa que precisen viajar a Bs.As. </p>" _
& "<p>Nos complace poder  asesorarlos con propuestas que se adapten a sus necesidades, brindando una experiencia única.</p>" _
& "<p>Contamos con 2 hoteles, de distintas categorías, en donde hemos implementado las medidas establecidas por el Gobierno Nacional y la OMS. Junto a ello, los protocolos establecidos por la ciudad de Buenos Aires. Con el objetivo de garantizar una estadía segura.</p>" _
& "<p>En adjunto podrá encontrar una breve presentación de los hoteles y nuestros protocolos.</p>" _
& "<p> Loi suites Esmeralda: ubicado en micro centro (M. T. Alvear 842) cuenta con las comodidades de un departamento (habitación + kitchenet) y los servicios de un hotel. (limpieza diaria, seguridad, wifi y desayuno incluidos): <a  href=" & "https://drive.google.com/drive/folders/1ATePDzJMGb8jChGk06NkU_FCB6YVXymX >Acceso a fotos y contenidos</a> (hacer click aquí para conocer el hotel)</p>" _
& "<p>Loi Suites Recoleta: ubicado en pleno barrio de la Recoleta, (Vicente Lopez 1955), hotel 5 estrellas, con piscina, gym y sauna). Servicio y atención exclusiva. <a  href=" & "https://drive.google.com/drive/folders/0B5yn0ieZMlx-Nklvb1ZaLUlqS3M > Loi Suites Recoleta</a> (hacer click aquí para conocer el hotel).</p>" _
& "<p>Si todavía nuestros ejecutivos comerciales no se ha contactado con ustedes para brindarles nuestras nuevas tarifas e información sobre cuidado al huésped, por favor avísenos que lo contactaremos a la brevedad.</p>" _
